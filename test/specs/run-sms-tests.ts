...
// async function runSMSTests(): Promise<void> {
//   try {
...
//     if (bPartyDevice) console.log(`📱 B-Party Device  : ${bPartyDevice}`);
...
//         deviceId,     aPartyNumber,
//         bPartyDevice || null, bPartyDevice ? bPartyNumber : null
//       );
...
//     let driver: Awaited<ReturnType<typeof DriverManager.initializeDriverForMessaging>>;
//     try {
//       driver = await DriverManager.initializeDriverForMessaging(deviceId, platformVer);
//       if (!driver) throw new Error('Driver creation returned null/undefined');
...
//         try {
//           const receiveResult = await verifier.verifyMessageReceived(
//             bPartyDevice,
//             aPartyNumber,   // sender's number as seen by receiver
//             testMessage,
//             sendStart,
//             120_000         // 2-minute SLA
//           );
