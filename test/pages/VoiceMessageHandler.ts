...
export class VoiceMessageHandler {
     ...
     */
    async sendVoiceMessage(phoneNumber: string): Promise<boolean> {
     ...
     */
    async sendVoiceMessageWithDetails(phoneNumber: string): Promise<Map<string, any>> {
    ...
    private async findVoiceButtonUltimate(): Promise<any> {
        const locators = [
    ...
    private async findVoiceButtonByPosition(): Promise<any> {
        try {
    ...
    private async holdVoiceButtonUltimate(voiceButton: any, durationMs: number): Promise<boolean> {
        try {
    ...
    private async sendVoiceMessageUltimate(): Promise<boolean> {
        try {
