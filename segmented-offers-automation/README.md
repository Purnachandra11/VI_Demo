...
The device serial defaults to `ZA222V9QNF`. Override it with the `DEVICE_SERIAL` environment variable if you use a different device.
...
|---|---|---|
| `DEVICE_SERIAL` | `ZA222V9QNF` | ADB device serial for the Android device |
