...
exports.SiebelSelectors = void 0;
exports.SiebelSelectors = {
    // Login Page
    login: {
    ...
    subscriptions: {
        ...
        // Table rows - dynamic
        rowByIndex: (index) => `//*[@id="s_7_l"]/tbody/tr[${index}]`,
        // Cell values within a row
        statusCell: (rowIndex) => `//*[@id="s_7_l"]/tbody/tr[${rowIndex}]/td[@aria-describedby="s_7_l_Status"]`,
        assetNumberLink: (rowIndex) => `//*[@id="s_7_l"]/tbody/tr[${rowIndex}]/td[@aria-describedby="s_7_l_Asset_Number"]/a`,
        activationDateCell: (rowIndex) => `//*[@id="s_7_l"]/tbody/tr[${rowIndex}]/td[@aria-describedby="s_7_l_TM_Install_Date"]`,
        msisdnCell: (rowIndex) => `//*[@id="s_7_l"]/tbody/tr[${rowIndex}]/td[@aria-describedby="s_7_l_MSISDN"]`,
        // Applet container
    ...
    invoice: {
        ...
        invoiceDateCell: (rowIndex) => `//*[@id="s_5_l"]/tbody/tr[${rowIndex}]/td[@aria-describedby="s_5_l_Statement_Date"]`,
        invoiceLinkCell: (rowIndex) => `//*[@id="s_5_l"]/tbody/tr[${rowIndex}]/td[@aria-describedby="s_5_l_Invoice_Number"]/a`,
    },
};
