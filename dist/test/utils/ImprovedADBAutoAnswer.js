...
exports.ImprovedADBAutoAnswer = void 0;
// src/utils/ImprovedADBAutoAnswer.ts
const child_process_1 = require("child_process");
const util_1 = require("util");
const execAsync = (0, util_1.promisify)(child_process_1.exec);
class ImprovedADBAutoAnswer {
    constructor(deviceId, expectedCaller) {
        this.running = false;
     ...
     */
    async monitorAndAnswerCallsAggressive() {
        var _a;
        ...
        try {
            ...
            // Continue monitoring
            if (!((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes('ENOENT'))) {
     ...
     */
    async executeADBCommandQuick(command) {
        try {
...
exports.ImprovedADBAutoAnswer = ImprovedADBAutoAnswer;
